...
/*   Updated: 2022/09/22 14:50:40 by mlancac          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form( std::string const& name, bool isSigned, int signedGrade,
	int executeGrade ) throw( std::exception )
	: _name( name ), _isSigned( isSigned ), _signedGrade( signedGrade ),
